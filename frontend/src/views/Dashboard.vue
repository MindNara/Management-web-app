<template>
    ...
    <div style="height: 100vh; width: 100%;">
        ...
        <div class="columns" style="height: 12vh;">
            ...
            <div class="pt-5">
                <span class="is-size-2-fullhd is-size-3-widescreen has-text-weight-medium has-text-black">Dashboard</span>
            </div>
            </div>
        ...
        <div class="container-content columns" style="height: 88vh;">
            ...
            <div class="content-tt columns" style="height: 35vh;">
                ...
                <div class="level columns" style="height: 5vh;">
                    ...
                    <div class="column">
                        <span class="has-text-black is-size-4-fullhd has-text-weight-medium is-size-5-widescreen">
                        Today Tasks
                        </span>
                    </div>
                    </div>
                ...
                <div class="columns" style="height: 30vh;">
                    ...
                    <div class="column">
                        ...
                        <div class="level-left">
                            ...
                            <a class="has-text-black"><i class='bx bx-check-circle mx-4 is-size-3'></i></a>
                        ...
                        <div class="level-right">
                            ...
                            <span class="btn-status has-background-black has-text-white has-text-weight-light mx-4">In
                                Progress</span>
                            </div>
                        </div>
                        </div>
